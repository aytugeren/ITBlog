...
namespace ITBlog.DataAccess.Migrations
{
    ...
    [Migration("20221102040015_pictureTableUpdatedWithIsDefaultParameter")]
    partial class pictureTableUpdatedWithIsDefaultParameter
    {
            ...
            modelBuilder.Entity("ITBlog.Entities.Concrete.AuthorFolder.Author", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 2, 4, 0, 15, 761, DateTimeKind.Utc).AddTicks(6727));
            ...
            modelBuilder.Entity("ITBlog.Entities.Concrete.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 2, 7, 0, 15, 761, DateTimeKind.Local).AddTicks(5594));
            ...
            modelBuilder.Entity("ITBlog.Entities.Concrete.PictureFolder.Picture", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 2, 4, 0, 15, 761, DateTimeKind.Utc).AddTicks(8474));
            ...
            modelBuilder.Entity("ITBlog.Entities.Concrete.PlaceFolder.Place", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 2, 4, 0, 15, 761, DateTimeKind.Utc).AddTicks(9744));
            ...
            modelBuilder.Entity("ITBlog.Entities.Concrete.PostFolder.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 2, 4, 0, 15, 761, DateTimeKind.Utc).AddTicks(4401));
