...
namespace ITBlog.DataAccess.Migrations
{
    ...
    [Migration("20221107162557_userandcommententitiesadded")]
    partial class userandcommententitiesadded
    {
            ...
            modelBuilder.Entity("ITBlog.Entities.Concrete.AuthorFolder.Author", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 7, 16, 25, 57, 175, DateTimeKind.Utc).AddTicks(540));
            ...
            modelBuilder.Entity("ITBlog.Entities.Concrete.AuthorPictureFolder.AuthorPicture", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 7, 16, 25, 57, 176, DateTimeKind.Utc).AddTicks(7125));
            ...
            modelBuilder.Entity("ITBlog.Entities.Concrete.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 7, 19, 25, 57, 174, DateTimeKind.Local).AddTicks(9582));
            ...
            modelBuilder.Entity("ITBlog.Entities.Concrete.CategoryPlaceFolder.CategoryPlace", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 7, 16, 25, 57, 177, DateTimeKind.Utc).AddTicks(459));
            ...
            modelBuilder.Entity("ITBlog.Entities.Concrete.CommentFolder.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 7, 16, 25, 57, 177, DateTimeKind.Utc).AddTicks(6540));
            ...
            modelBuilder.Entity("ITBlog.Entities.Concrete.PictureFolder.Picture", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 7, 16, 25, 57, 175, DateTimeKind.Utc).AddTicks(2244));
            ...
            modelBuilder.Entity("ITBlog.Entities.Concrete.PlaceFolder.Place", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 7, 16, 25, 57, 175, DateTimeKind.Utc).AddTicks(3372));
            ...
            modelBuilder.Entity("ITBlog.Entities.Concrete.PostCategoryFolder.PostCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 7, 16, 25, 57, 175, DateTimeKind.Utc).AddTicks(9796));
            ...
            modelBuilder.Entity("ITBlog.Entities.Concrete.PostFolder.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 7, 16, 25, 57, 174, DateTimeKind.Utc).AddTicks(8775));
            ...
            modelBuilder.Entity("ITBlog.Entities.Concrete.PostPictureFolder.PostPicture", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 7, 16, 25, 57, 175, DateTimeKind.Utc).AddTicks(5826));
            ...
            modelBuilder.Entity("ITBlog.Entities.Concrete.PostPlaceFolder.PostPlace", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 7, 16, 25, 57, 176, DateTimeKind.Utc).AddTicks(3692));
            ...
            modelBuilder.Entity("ITBlog.Entities.Concrete.SocialMediaFolder.SocialMedia", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 7, 16, 25, 57, 177, DateTimeKind.Utc).AddTicks(3878));
            ...
            modelBuilder.Entity("ITBlog.Entities.Concrete.SubscriberFolder.Subscriber", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 7, 19, 25, 57, 177, DateTimeKind.Local).AddTicks(3035));
            ...
            modelBuilder.Entity("ITBlog.Entities.Concrete.UserFolder.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 7, 16, 25, 57, 177, DateTimeKind.Utc).AddTicks(4965));
