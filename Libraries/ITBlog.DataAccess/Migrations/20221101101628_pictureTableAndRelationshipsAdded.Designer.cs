...
namespace ITBlog.DataAccess.Migrations
{
    ...
    [Migration("20221101101628_pictureTableAndRelationshipsAdded")]
    partial class pictureTableAndRelationshipsAdded
    {
            ...
            modelBuilder.Entity("ITBlog.Entities.Concrete.AuthorFolder.Author", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 1, 10, 16, 28, 189, DateTimeKind.Utc).AddTicks(8212));
            ...
            modelBuilder.Entity("ITBlog.Entities.Concrete.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 1, 13, 16, 28, 189, DateTimeKind.Local).AddTicks(6885));
            ...
            modelBuilder.Entity("ITBlog.Entities.Concrete.PictureFolder.Picture", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 1, 10, 16, 28, 190, DateTimeKind.Utc).AddTicks(641));
            ...
            modelBuilder.Entity("ITBlog.Entities.Concrete.PostFolder.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 1, 10, 16, 28, 189, DateTimeKind.Utc).AddTicks(5370));
